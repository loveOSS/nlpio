from nlptools.nlptools import strip_html_tags, replace_accented_chars, remove_special_characters, clean_corpus
...
class TestNlptools():
    ...
    def test_remove_punctuation(self):
        ...
        assert 'Hi everyone  except you ' == remove_special_characters(punctuation_sentence)

    def test_remove_punctuation_and_numbers(self):
        complex_sentence = "How old is she ? She is 17 years old"
        assert 'How old is she  She is  years old' == remove_special_characters(complex_sentence, True)

    def test_clean_corpus(self):
        corpus = [
            "Hi; everyone - except you ?",
            "<h1>Hello</h1>",
            "This is my intent©"
        ]
